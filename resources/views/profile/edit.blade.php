                        ...
                        <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
                            ...
                            <div>
                                ...
                                <input id="umumPhone" name="umumPhone" type="text" class="mt-1 block w-full"
                                    value="{{ old('umumPhone', $user->umumPhone) }}" required autocomplete="phone" />
                                @error('umumPhone')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input id="umumCity" name="umumCity" type="text" class="mt-1 block w-full"
                                    value="{{ old('umumCity', $user->umumCity) }}" required autocomplete="city" />
                                @error('umumCity')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input id="umumDOB" name="umumDOB" type="date" class="mt-1 block w-full"
                                    value="{{ old('umumDOB', $user->umumDOB) }}" required autocomplete="city" />
                                @error('umumDOB')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group d-flex justify-content-end">
                                <button type="submit" class="btn btn-danger"
                                    style="margin-top: 0.5cm; transform: scale(1.2);">{{ __('Save') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
