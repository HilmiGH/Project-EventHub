...
class SeputarProfileController extends Controller
{
    public function myProfile()
    {
        // // mengambil data dari table pegawai
        // $akunumum = DB::table('users')->get();
    ...
    public function editProfile($id){
        ...
        $akunumum = DB::table('users')->where('umumID',$id)->get();
        // passing data pegawai yang didapat ke view edit.blade.php
        return view('EditProfile',['users' => $akunumum]);
    }
    ...
    public function myProfileUpdate(Request $request)
    {
        ...
        // update data pegawai
	    DB::table('users')->where('umumID',$request->umumid)->update([
